...
//   "/add-post", // ruuning the controller function so I did it manually passing the post names in the header from front-end
//   (req, res, next) => { // and the proper backend path is created in the user controller addNewPost function's postUrlArray Array
//     date.setDate(Date.now());
//     next();
//   },
//   userController.addNewPost
// );
app.post("/add-post", upload.array("postImages", 10), (req, res)=>{
  console.log("rudkjhfasjkdfhjklasdh")
});
