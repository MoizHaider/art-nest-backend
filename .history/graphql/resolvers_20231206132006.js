    ...
    const response = await db.collection("posts")
      .aggregate([
        ...
        {$lookup: {
          ...
          $project:{ 
            text: "$comments.text",
            "userData.name":"$useData[0].name",
            "userData.email":"$useData[0].email",
            "userData._id": "$useData[0]._id",
            "userData.profilePicUrl": "$useData[0].profilePicUrl",
      ...
      console.log("res de ", response[0].userData)
  },
};
