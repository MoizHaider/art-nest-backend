...
module.exports = {
  ...
  async delComment(args, req){
    ...
    db.posts.updateOne(
      { _id: new ObjectId("657e6ea79407443e095a03d4"), "comments.commentId": ObjectId("65866aab3aaf152909c36ad6") },
      { $pull: { comments: { commentId: ObjectId("65866aab3aaf152909c36ad6") } }, $set: { score: 0.123 } }
    );
  }
};
